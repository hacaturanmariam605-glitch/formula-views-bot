...
async def finish_quiz(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    # --- Похвала в зависимости от результата ---
    if score == total:
        praise = "🤍 Отличная работа, ты молодец! Ты идеально знаешь все 5 формул и готова применять их в своих роликах."
    elif score == total - 1:
        praise = "🤍 Отличная работа, ты почти всё знаешь! Осталось совсем чуть-чуть — перечитай статью, и всё встанет на свои места."
    elif score == total - 2:
        praise = "🤍 Ты уже на верном пути! Теперь у тебя есть основа, и это круто. Перечитай статью, чтобы точно запомнить все 5 формул."
    else:
        praise = "🤍 Не расстраивайся! Ты всегда можешь вернуться к статье и изучить информацию. Самое важное — не бояться и пробовать."

    caption = (
        f"{praise}\n\n"
        "Если хочешь системно вести блог с пониманием, сотрудничать с брендами и чувствовать себя уверенно — оставь заявку на мини-курс «OH MY BRAND».\n\n"
        "Заполняй анкету презаписи, чтобы сохранить за собой цену — 5 500 ₽ (вместо 10 000).\n"
