...
async def finish_quiz(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    if score == total:
        ...
        praise = f"🤍 **{score}/{total}** — Отличная работа, ты почти всё знаешь! Осталось совсем чуть-чуть — перечитай статью, и всё встанет на свои места."
    elif score == total - 2:
        praise = f"🤍 **{score}/{total}** — Ты уже на верном пути! Теперь у тебя есть основа, и это круто. Перечитай статью, чтобы точно запомнить все 5 формул."
    else:
        praise = f"🤍 **{score}/{total}** — Не расстраивайся! Ты всегда можешь вернуться к статье и изучить информацию. Самое важное — не бояться и пробовать."
